...
Para a base `receita_expansao`, o campo `TOP` é obrigatório. O único valor aceito é:

```text
1100 - VENDA DE MERCADORIA
```

Essa trava evita que pedidos de venda entrem como receita/faturamento na análise de expansão, Margin Pool e over/under share. O importador aceita `1100` e normaliza para o texto completo, mas rejeita qualquer outro TOP.
